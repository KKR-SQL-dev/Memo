...
export default function FloatingToolbar({
  ...
  return (
    <div
      ref={barRef}
      className="absolute z-50 flex items-center gap-2 px-5 py-4 bg-white/95 dark:bg-[#1e1e2e]/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200 dark:border-[#444]"
    ...
    >
      ...
      <div className="w-px h-12 bg-gray-300 dark:bg-[#555] mx-2" />
      ...
      <div className="relative">
        <button
          ...
          className="p-4 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#333] transition-colors"
          title="글자색"
        >
          <Palette size={ICON} />
      ...
      <button
        onClick={onUndo}
        disabled={!canUndo}
        className="p-4 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#333] transition-colors disabled:opacity-30"
        title="되돌리기 (Ctrl+Z)"
      >
        <Undo2 size={ICON} />
      </button>
